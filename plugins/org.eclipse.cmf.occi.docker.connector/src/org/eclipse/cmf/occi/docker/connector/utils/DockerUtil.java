...
public class DockerUtil {
	...
	public static String getEnv(final String machineName) throws DockerException {
		...
		final String defaultMachineCertPath = IterableExtensions.join(Collections.<String>unmodifiableList(
				CollectionLiterals.<String>newArrayList(_property, ".docker", "machine", "machines", machineName)),
				File.separator);
	...
	public static boolean isUnix() {
		return (((DockerUtil.OS.indexOf("nix") >= 0) || (DockerUtil.OS.indexOf("nux") >= 0))
				|| (DockerUtil.OS.indexOf("aix") > 0));
	}
