...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.docker.Network} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkItemProvider extends org.eclipse.cmf.occi.infrastructure.provider.NetworkItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAuxAddressPropertyDescriptor(object);
			addDriverPropertyDescriptor(object);
			addGatewayPropertyDescriptor(object);
			addInternalPropertyDescriptor(object);
			addIpRangePropertyDescriptor(object);
			addIpamDriverPropertyDescriptor(object);
			addIpamOptPropertyDescriptor(object);
	 ...
	 * @generated
	 */
	protected void addAuxAddressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_auxAddress_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_auxAddress_feature", "_UI_Network_type"),
	 ...
	 * @generated
	 */
	protected void addIpRangePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_ipRange_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_ipRange_feature", "_UI_Network_type"),
	 ...
	 * @generated
	 */
	protected void addIpamDriverPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_ipamDriver_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_ipamDriver_feature", "_UI_Network_type"),
	 ...
	 * @generated
	 */
	protected void addIpamOptPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_ipamOpt_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_ipamOpt_feature", "_UI_Network_type"),
