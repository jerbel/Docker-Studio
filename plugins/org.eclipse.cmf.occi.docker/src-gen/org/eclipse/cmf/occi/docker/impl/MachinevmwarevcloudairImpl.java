...
public class MachinevmwarevcloudairImpl extends MachineImpl implements Machinevmwarevcloudair {
	 ...
	 * @ordered
	 */
	protected static final Integer CPU_COUNT_EDEFAULT = new Integer(1);
	 ...
	 * @ordered
	 */
	protected Integer cpuCount = CPU_COUNT_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected Integer dockerPort = DOCKER_PORT_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final Integer SSH_PORT_EDEFAULT = new Integer(22);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DockerPackage.MACHINEVMWAREVCLOUDAIR__CPU_COUNT:
				...
				return;
			case DockerPackage.MACHINEVMWAREVCLOUDAIR__DOCKER_PORT:
				setDockerPort((Integer)newValue);
				return;
			case DockerPackage.MACHINEVMWAREVCLOUDAIR__EDGEGATEWAY:
